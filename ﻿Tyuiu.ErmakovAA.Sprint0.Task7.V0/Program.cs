using Tyuiu.ErmakovAA.Sprint0.Task7.V0.Lib;
namespace Tyuiu.ErmakovAA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполгил: Ермаков А.А. | ПКТб-24-1";
            ...
            if (arrayNums1.Length == arrayNums2.Length)
            {
                ...
                Console.WriteLine("Сумма элементов массива равно:");
